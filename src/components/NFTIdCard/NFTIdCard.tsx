    ...
    <div ref={containerRef} className="flex justify-center h-auto min-h-[442px]">
      ...
      >
        ...
        <div className="card-base">
          {/* Static border with slow natural color transitions */}
          ...
          <div className="card-content p-6">
            ...
            <div className="absolute top-[25%] left-[32%] right-[5%] flex flex-row gap-2 justify-end">
              ...
              <div className="glass rounded-lg p-3 flex flex-col items-center">
                ...
                <p className="text-xs text-gray-300">Social Score</p>
                <p className="text-sm font-bold text-[var(--primary)]">{userData?.socialScore || 750}</p>
              </div>
              {/* Rank */}
            ...
            {/* QR Code - Using proper QR code library */}
            <div 
              ref={qrContainerRef}
